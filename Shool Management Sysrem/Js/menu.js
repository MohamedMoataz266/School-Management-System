...
function studentAffairsMenu(){
    $.get("homemenu.php", function(data){
        ...
        $(".atr4").replaceWith('<a href="updatestudent.php">Update Student</a>');
        $(".atr5").replaceWith('<a href="homepage.php">Log Out</a>');
    });
}
function personnelMenu(){
    $.get("homemenu.php", function(data){
        ...
        $(".atr4").replaceWith('<a href="updateemployee.php">update Employee</a>');
        $(".atr5").replaceWith('<a href="homepage.php">Log Out</a>');
    });
}
